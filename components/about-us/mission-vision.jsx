    ...
    <FadeIn>
      <div className="w-full h-full max-w-[1600px] mx-auto my-6 lg:mt-[11rem] 2xl:mt-[15rem] 4xl:mt-[25rem] text-center font-Avenir-Medium">
        <div className="relative h-full w-full flex items-center justify-start flex-col xl:w-11/12 py-14 lg:px-20 2xl:px-0 mx-auto">
          <div className="w-full px-4 grid grid-cols-1 md:grid-cols-2 gap-6 2xl:gap-16 mx-auto">
            <div className="relative mission w-full h-full 2xl:h-[770px] overflow-hidden flex flex-col items-center justify-between gap-6 rounded-2xl">
              <div className="flex flex-col items-center justify-center gap-6 px-10 pt-16">
                ...
                <p className="text-black text-sm md:text-base font-medium !leading-8 2xl:px-10">
            ...
            <div className="relative vision w-full h-full 2xl:h-[770px] overflow-hidden flex flex-col items-center justify-between gap-6 rounded-2xl">
              <div className="flex flex-col items-center justify-center gap-6 px-10 pt-16">
                <Image src={Diamond} alt="mission" className="w-10 h-10" />
                <p className="text-primary-green font-Avenir-Heavy font-bold text-2xl sm:text-3xl md:text-4xl xl:text-[40px]">
                  Our Values
