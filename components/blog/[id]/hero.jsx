...
export const Hero = ({ blog }) => {
  return (
    <FadeIn classname="lg:!pb-16">
      <div
        className="w-full h-[40vh] md:h-[70vh] single-blog-image flex flex-col justify-center"
        style={{
          backgroundImage: `url('${blog?.img}')`,
        }}
      >
        <div className="bg-[#000]/20 backdrop-brightness-50 p-8 text-white relative w-full h-full flex items-center justify-center flex-col pt-12 py-6 lg:p-20 lg:pt-40 !pb-0 mx-auto">
