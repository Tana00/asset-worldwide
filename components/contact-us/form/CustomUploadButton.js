export const CustomUploadButton = ({ name, file, handleFileChange, error }) => {
  return (
    <div className="flex flex-col items-start w-full">
      <div className="bg-blue-light text-black border-none rounded-lg flex flex-col items-start w-full justify-between">
      ...
      <div className="w-full border border-[#CC9933] bg-[#FAF5EB] rounded-lg px-4 py-3.5">
        {!file ? (
          <label className="bg-primary-gold rounded-lg cursor-pointer flex flex-col items-center justify-center px-6 py-3">
            <input
              name={name}
              type="file"
          ...
          <div className="w-full bg-primary-gold rounded-lg flex items-center justify-between px-6 py-5">
