export const Hero = () => {
  return (
    <div className="w-full h-full lg:h-[60vh] contact-image flex flex-col justify-center p-8">
      <div className="w-full lg:w-4/5 mx-auto">
        <div className="flex-1 flex flex-col justify-center gap-2 lg:gap-6 py-4 lg:py-0">
