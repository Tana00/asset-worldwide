  ...
  return (
    <div className="w-full mt-6 min-h-screen overflow-x-hidden">
      <div className="w-full flex items-start justify-start flex-col xl:w-11/12 bg-green-light py-14 lg:px-20 mx-auto hero-container">
        <div className="flex flex-col sm:w-full mx-4 sm:mx-8 xl:mx-0 xl:w-4/5 3xl:w-3/5 gap-3 xl:gap-4">
          <p className="text-primary-gold font-Avenir-Heavy font-semibold text-sm md:text-lg">
            Welcome To Assets Worldwide Real Estate
          </p>
          <h2 className="font-Trajan sm:tracking-wider text-[#044625] text-[2.2rem] font-bold sm:leading-[65px] xl:leading-[78px] md:text-[3rem] xl:text-[4rem] 2xl:text-[4.5rem] 2xl:leading-[85px] sm:w-4/5">
            Turning Houses <br /> into
            <span className="text-[#006633]"> Dream Homes</span>
          </h2>
          <p className="text-black text-base !leading-6 md:text-lg lg:!leading-8 font-light w-full md:w-3/4 xl:w-3/5 font-Avenir-Medium">
