...
const Navbar = () => {
  ...
  return (
    <nav className="w-full md:w-11/12 lg:w-4/5 xsl:w-11/12 2xxl:w-4/5 mx-auto flex justify-between items-center px-4 xsl:px-0 xl:px-4 my-4 md:my-6 bg-white font-Avenir">
      <div className="">
        <Link href="/">
